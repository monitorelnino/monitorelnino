...
const PAGINAS = ["index.html", "pesquisadores.html", "calendario-eleitoral.html", "defesa-civil.html", "monitor-de-riscos.html", "saude.html", "financiamento.html", "proteja-se.html", "prefeituras.html", "obrigado.html", "imprensa.html"].filter(p => fs.existsSync(path.join(RAIZ, p)));
const PROIBIDOS = [
