...
for (const arq of arquivos) {
  ...
  const NAV_ORDEM = ["MARÉ Legal", "Monitor de risco", "Proteja-se", "Defesa civil", "MARÉ Saúde", "Financiamento", "Para gestores", "Imprensa", "Pesquisadores"];   // 15/09/2026 (pedido da editoria): O monitor → MARÉ Legal · Risco climático → Monitor de risco · Saúde → MARÉ Saúde · Prefeituras → Para prefeitos (arquivos e URLs inalterados); ordem de 14/09 mantida
