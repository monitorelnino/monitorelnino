...
const html = fs.readFileSync(path.join(raiz, "calendario-eleitoral.html"), "utf-8").replace(/<script[\s\S]*?<\/script>/g, "");
...
const pagina = fs.readFileSync(path.join(raiz, "calendario-eleitoral.html"), "utf-8");
