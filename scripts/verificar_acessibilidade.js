...
const PAGINAS = ["index.html", "pesquisadores.html", "calendario-eleitoral.html","defesa-civil.html","monitor-de-riscos.html","saude.html","financiamento.html","proteja-se.html","prefeituras.html","obrigado.html","imprensa.html","blog.html"];
...
for (const p of PAGINAS) {
  ...
  if (p !== "obrigado.html" && !d.querySelector('.mainnav [aria-current="page"]')) if (p !== "calendario-eleitoral.html" && p !== "blog.html") falha(`${p}: nav sem aria-current="page"`);
