...
def checar(html, rotas, serie, poruf, motor, arquivos_fin: dict) -> list:
    ...
    for cid in ["boxRotaMPs", "boxMpsBrUf", "boxMpsUf", "boxMpsUfBarras", "boxRede", "boxSerie", "boxFundoEstadual", "boxContadores", "boxDinheiro", "boxResposta", "boxCompromissos", "boxFinance"]:   # boxFontesMonit/boxConsultas vivem em pesquisadores.html (07/09/2026); boxPorHab retirado do HTML em 13/09/2026 (auditoria de visualizações) — sem cobertura mínima (1/8 rotas), JS mantido desativado; boxMpsBrUf adicionado em 13/09/2026 (consolidação: BR × UFs destacado primeiro); boxPainel migrou para pesquisadores.html em 13/09/2026 (proposta de enxugamento, Manus AI)
