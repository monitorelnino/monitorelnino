...
```
 1. node   scripts/verificar_estrutura.js        (12 páginas; tokens.css; nav canônica; :root inline proibido; paleta semântica única: cores de dado só via MonitorMapas.PALETA)
