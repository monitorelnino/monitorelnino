...
ROTAS = [
    {"alcanca_estado": True, "base_estado": "FPE — CF art. 159, I, a (21,5% de IR+IPI aos estados) e cota-parte do ICMS (art. 158, IV) repassada aos municípios", "id": "r1", "n": 1, "nome": "Repartição constitucional", "curta": "FPM · cota ICMS/IPVA", "chave": "regra", "cor": "#35566B",
    ...
    {"alcanca_estado": True, "base_estado": "fundo a fundo aos fundos estaduais de saúde e de assistência social (Lei 8.080/1990; Lei 8.742/1993); FUNDEB com complementação da União aos estados", "id": "r2", "n": 2, "nome": "Fundo a fundo setorial", "curta": "FNS · FNAS · FUNDEB/FNDE", "chave": "regra", "cor": "#5E7C93",
    ...
    {"alcanca_estado": True, "base_estado": "Lei 12.340/2010, art. 1º: transferências da União a estados E municípios para resposta, recuperação e prevenção; estados repassam ou executam", "id": "r3", "n": 3, "nome": "Defesa civil obrigatória", "curta": "resposta · recuperação · prevenção-obra (CPDC)", "chave": "decreto", "cor": "#7C4A34",
    ...
    {"alcanca_estado": True, "base_estado": "portarias do MS e do MDS também habilitam gestores estaduais (SUS/SUAS) em emergência", "id": "r4", "n": 4, "nome": "Emergência setorial", "curta": "SUAS/PVAC · portarias do MS", "chave": "decreto", "cor": "#A65F3F",
    ...
    {"alcanca_estado": True, "base_estado": "convênios e emendas com finalidade também a órgãos estaduais (Transferegov); mesma vedação eleitoral", "id": "r5", "n": 5, "nome": "Voluntárias e emendas com finalidade", "curta": "Transferegov · emendas individuais/bancada", "chave": "discricionária", "cor": "#C69B72",
    ...
    {"alcanca_estado": True, "base_estado": "CF art. 166-A: transferências especiais a estados e municípios", "id": "r6", "n": 6, "nome": "Transferências especiais", "curta": "art. 166-A, I (emendas 'pix')", "chave": "discricionária", "cor": "#87855C",
     "base_legal": "CF art. 166-A, I (EC 105/2019): sem finalidade definida, sem convênio", "decreto_destranca": "nada", "ex_ante": True},
    {"alcanca_estado": False, "base_estado": None, "id": "r7", "n": 7, "nome": "Execução direta da União no território", "curta": "Carro-Pipa · Cisternas · Garantia-Safra · obras federais", "chave": "direta", "cor": "#647A7E",
    ...
    {"alcanca_estado": None, "base_estado": "origem ESTADUAL: cota ICMS (CF art. 158, IV), fundo a fundo preventivo (Prepara RS) e convênios estaduais", "id": "rE", "n": 8, "nome": "Rota estadual", "curta": "cota ICMS · fundo a fundo preventivo (Prepara RS) · convênios", "chave": "regra/discricionária", "cor": "#4F7D48",
