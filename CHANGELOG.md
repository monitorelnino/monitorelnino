...
**Achado da primeira rodada real.** O render leu 20 linhas de 62 e **nenhuma** casou com o IBGE: o extrator pegava a primeira grade da página, e o Power BI desenha vários visuais. Não era leitura parcial — era tabela errada. Corrigido com escolha por pontuação entre todas as grades, e com porta de qualidade no coletor: leitura em que quase nada casa com o IBGE vira lacuna declarada, nunca item de fila. Sem essa porta, as 20 linhas de lixo tinham ido para a fila de triagem humana parecendo dado.
